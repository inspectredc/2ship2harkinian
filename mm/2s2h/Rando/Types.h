...
typedef enum {
    ...
    RC_BENEATH_THE_GRAVEYARD_TOMBSTONE,
    ...
    RC_BOMB_SHOP_ITEM_2,
    RC_BOMB_SHOP_ITEM_3,
    RC_BOMB_SHOP_ITEM_OR_CURIOSITY_SHOP_ITEM,
    ...
    RC_BENEATH_THE_GRAVEYARD_POT_DAMPE_01,
    RC_BENEATH_THE_GRAVEYARD_POT_DAMPE_02,
    RC_BENEATH_THE_GRAVEYARD_POT_DAMPE_03,
    RC_BENEATH_THE_GRAVEYARD_POT_DAMPE_04,
    RC_BENEATH_THE_GRAVEYARD_POT_DAMPE_05,
    RC_BENEATH_THE_GRAVEYARD_POT_DAMPE_06,
    RC_BENEATH_THE_GRAVEYARD_POT_DAMPE_07,
    RC_BENEATH_THE_GRAVEYARD_POT_DAMPE_08,
    RC_BENEATH_THE_GRAVEYARD_POT_DAMPE_09,
    ...
    RC_BENEATH_THE_WELL_POT_MIDDLE_01,
    RC_BENEATH_THE_WELL_POT_MIDDLE_02,
    RC_BENEATH_THE_WELL_POT_MIDDLE_03,
    RC_BENEATH_THE_WELL_POT_MIDDLE_04,
    RC_BENEATH_THE_WELL_POT_MIDDLE_05,
    RC_BENEATH_THE_WELL_POT_MIDDLE_06,
    RC_BENEATH_THE_WELL_POT_MIDDLE_07,
    RC_BENEATH_THE_WELL_POT_MIDDLE_08,
    RC_BENEATH_THE_WELL_POT_MIDDLE_09,
    ...
    RC_DEKU_PLAYGROUND_DAY_1_RUPEE_1,
    RC_DEKU_PLAYGROUND_DAY_1_RUPEE_2,
    RC_DEKU_PLAYGROUND_DAY_1_RUPEE_3,
    RC_DEKU_PLAYGROUND_DAY_1_RUPEE_4,
    RC_DEKU_PLAYGROUND_DAY_1_RUPEE_5,
    RC_DEKU_PLAYGROUND_DAY_1_RUPEE_6,
    RC_DEKU_PLAYGROUND_DAY_2_RUPEE_1,
    RC_DEKU_PLAYGROUND_DAY_2_RUPEE_2,
    RC_DEKU_PLAYGROUND_DAY_2_RUPEE_3,
    RC_DEKU_PLAYGROUND_DAY_2_RUPEE_4,
    RC_DEKU_PLAYGROUND_DAY_2_RUPEE_5,
    RC_DEKU_PLAYGROUND_DAY_2_RUPEE_6,
    RC_DEKU_PLAYGROUND_DAY_3_RUPEE_1,
    RC_DEKU_PLAYGROUND_DAY_3_RUPEE_2,
    RC_DEKU_PLAYGROUND_DAY_3_RUPEE_3,
    RC_DEKU_PLAYGROUND_DAY_3_RUPEE_4,
    RC_DEKU_PLAYGROUND_DAY_3_RUPEE_5,
    RC_DEKU_PLAYGROUND_DAY_3_RUPEE_6,
    ...
    RC_DOGGY_RACETRACK_LARGE_CRATE_01,
    RC_DOGGY_RACETRACK_LARGE_CRATE_02,
    RC_DOGGY_RACETRACK_LARGE_CRATE_03,
    ...
    RC_GREAT_BAY_TEMPLE_COMPASS_ROOM_FREESTANDING_RUPEE_01,
    RC_GREAT_BAY_TEMPLE_COMPASS_ROOM_FREESTANDING_RUPEE_02,
    ...
    RC_GREAT_BAY_TEMPLE_POT_BEFORE_WART_01,
    RC_GREAT_BAY_TEMPLE_POT_BEFORE_WART_02,
    RC_GREAT_BAY_TEMPLE_POT_BEFORE_WART_03,
    RC_GREAT_BAY_TEMPLE_POT_BEFORE_WART_04,
    RC_GREAT_BAY_TEMPLE_POT_BEFORE_WART_05,
    RC_GREAT_BAY_TEMPLE_POT_BEFORE_WART_06,
    RC_GREAT_BAY_TEMPLE_POT_BEFORE_WART_07,
    RC_GREAT_BAY_TEMPLE_POT_BEFORE_WART_08,
    RC_GREAT_BAY_TEMPLE_POT_BEFORE_WART_09,
    ...
    RC_STONE_TOWER_POT_LOWER_SCARECROW_01,
    RC_STONE_TOWER_POT_LOWER_SCARECROW_02,
    RC_STONE_TOWER_POT_LOWER_SCARECROW_03,
    RC_STONE_TOWER_POT_LOWER_SCARECROW_04,
    RC_STONE_TOWER_POT_LOWER_SCARECROW_05,
    RC_STONE_TOWER_POT_LOWER_SCARECROW_06,
    RC_STONE_TOWER_POT_LOWER_SCARECROW_07,
    RC_STONE_TOWER_POT_LOWER_SCARECROW_08,
    RC_STONE_TOWER_POT_LOWER_SCARECROW_09,
    ...
    RC_STONE_TOWER_TEMPLE_POT_SPIKED_BAR_ROOM_1,
    RC_STONE_TOWER_TEMPLE_POT_SPIKED_BAR_ROOM_2,
    RC_STONE_TOWER_TEMPLE_POT_SPIKED_BAR_ROOM_3,
    RC_STONE_TOWER_TEMPLE_POT_SPIKED_BAR_ROOM_4,
    RC_STONE_TOWER_TEMPLE_POT_SPIKED_BAR_ROOM_5,
    RC_STONE_TOWER_TEMPLE_POT_SPIKED_BAR_ROOM_6,
    RC_STONE_TOWER_TEMPLE_POT_SPIKED_BAR_ROOM_7,
    RC_STONE_TOWER_TEMPLE_POT_SPIKED_BAR_ROOM_8,
    ...
    RC_WOODFALL_FREESTANDING_RUPEE_01,
    RC_WOODFALL_POT_1,
    RC_WOODFALL_POT_2,
    RC_WOODFALL_POT_3,
